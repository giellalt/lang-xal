...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_xal to login script."
...
# the current dir:
if   test x${GTLANG_xal} = x ; then
	echo "WARNING: The variable \${GTLANG_xal} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_xal} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_xal} has the value:"
	echo "  ${GTLANG_xal}"
