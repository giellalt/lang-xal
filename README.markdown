...
This directory contains source files for the Kalmyk language morphology
...
In order to compile and use Kalmyk language morphology and dictionaries,
you need:
...
The Kalmyk language sources can be acquired using [giella SVN
